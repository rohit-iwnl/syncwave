//
//  PersonalTraitsSecondView.swift
//  Stealth
//
//  Created by Rohit Manivel on 3/18/25.
//

import SwiftUI

struct PersonalTraitsSecondView: View {
    ...
    private let scoredQuestions: [TraitQuestionWithScore] = PersonalityTraitConstants.PersonalTraits
        .getRandomQuestionSet(questionsPerCategory: 1)
...
#Preview {
    PersonalTraitsSecondView(currentPage: .constant(1), totalPages: .constant(5))
